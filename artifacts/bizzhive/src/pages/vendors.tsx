...
export default function Vendors() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-display font-bold mb-2">Creators</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {vendors.map((vendor) => (
            <Link key={vendor.id} href={`/vendors/${vendor.id}`}>
              <Card className="group cursor-pointer hover:shadow-lg transition-all border-border/60 hover:border-primary/30 h-full">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        {vendor.featured && <Badge className="bg-accent text-accent-foreground text-xs">Featured</Badge>}
                      </div>
                      {vendor.location && (
